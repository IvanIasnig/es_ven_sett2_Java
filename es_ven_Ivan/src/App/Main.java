...
public class Main {
	...
	public static void main(String[] args) {
		...
		do {
			...
			switch (scelta) {
			case 1:
				aggiungiLibro(libri, scanner);
				break;

			case 2:
				rimuovi(libri, riviste, scanner);
				break;

			case 3:
				cercaPerISBN(libri, riviste, scanner);
				break;

			case 4:
				cercaPerAnno(libri, riviste, scanner);
				break;

			case 5:
				cercaPerAutore(libri, scanner);
				break;

			case 6:
				salvaDisco(libri, riviste);
				break;
	...
	public static void aggiungiLibro(Set<Libri> libri, Scanner scanner) {
		// Aggiugni libro
	...
	public static void rimuovi(Set<Libri> libri, Set<Riviste> riviste, Scanner scanner) {
		// Rimozione
	...
	public static void cercaPerISBN(Set<Libri> libri, Set<Riviste> riviste, Scanner scanner) {
		//ricerca per IBSN
	...
	public static void cercaPerAnno(Set<Libri> libri, Set<Riviste> riviste, Scanner scanner) {
		// Rierca per anno
	...
	public static void cercaPerAutore(Set<Libri> libri, Scanner scanner) {
		// Rierca per autore
	...
	public static void salvaDisco(Set<Libri> libri, Set<Riviste> riviste) {
	    //Salva su disco
	    String data = "";
	...
	public static void caricaDisco() {
	    // Caricamento dal disco
	    
	    try {
	        String lett = FileUtils.readFileToString(new File("archivio.txt"), StandardCharsets.UTF_8);
	        System.out.println("Archivio caricato: \n" + lett);
	    } catch (IOException e) {
	        System.err.println("Errore nel caricamento dell'archivio");
	        e.printStackTrace();
	    }
	}
}